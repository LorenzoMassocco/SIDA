...
%% Initialization of parameters, generation of data
...
disp("Actual Model:")
fprintf( 'Fden = Gden = [1.00, -0.96, 0.97]\n'); 
fprintf( 'Fnum = [0, 2.99, -0.2]\n');
fprintf( 'Gnum = [1]\n\n');
...
%% Confidence interval for ARX model 1

disp("Confidence interval for ARX model 1:")
orders_arx = [2 2 1]; 
...
fprintf('Estimate of P (ARX model 1):');
P
